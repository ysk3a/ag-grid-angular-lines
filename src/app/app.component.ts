...
import { ColDef, GridReadyEvent, ICellRendererParams, RowGroupingDisplayType, ValueParserParams } from 'ag-grid-community';
  ...
  public columnDefs: ColDef[] = [
    {
      field: 'athlete',
      minWidth: 250,
      cellRenderer: CellRendComponent,
      //   cellRendererParams: {
      //     innerRendererFramework: MyCustomCellRendererComponent
      // }

      //       cellRenderer: (params: ICellRendererParams) => {
      //         return `<span style="border-left: 1px solid red; display: flex; height: 100%">
      //         <div class="horizontal-line" style="border-bottom: 1px solid blue; flex: 1;
      //         height: 50%;"></div>
    ...
    { field: 'year', filter: true, rowGroup: true, hide: true },
    { field: 'date' },
    { field: 'sport', minWidth: 200, rowGroup: true, hide: true },
  ];
